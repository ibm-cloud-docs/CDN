...
一方、`Deny` の動作は、指定されたグループに対し、サービスへのアクセスをブロックします。しかし、指定されていないその他すべての地域については、アクセスを許可します。例えば、ヨーロッパ大陸とオセアニア大陸に対し、地理的アクセス制御のアクセス・タイプを `Deny` に設定した場合、それらの大陸のユーザーはサービスを使用**できなくなります**が、その他すべての大陸のユーザーはサービスにアクセスできます。
