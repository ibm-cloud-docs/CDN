...
Le [richieste semplici](https://www.w3.org/TR/cors/#simple-cross-origin-request) tramite CORS sono richieste `GET` o `POST` dalla pagina web di un'origine che sta provando a ottenere l'accesso all'URL di un'altra origine per delle risorse.
