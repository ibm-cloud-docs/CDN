...
* `listVendors` - Provides the list of supported vendors.  [Example code](./infrastructure/CDN/cdn-example-code.md#example-code-of-listing-vendors)
* `verifyOrder` - Verifies whether the order can be placed.  [Example code](./infrastructure/CDN/cdn-example-code.md#example-code-to-verify-order)
...
* `createDomainMapping` - Creates the CDN Mapping.  [Example code](./infrastructure/CDN/cdn-example-code.md#example-code-to-create-cdn-or-create-domain-mapping)
* `verifyDomainMapping` - Changes CDN status to _RUNNING_  [Example code](./infrastructure/CDN/cdn-example-code.md#example-code-of-verify-domain-mapping)
