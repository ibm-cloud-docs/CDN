...
* `listVendors` - Provides the list of supported vendors.  [Example code ![External link icon](../../icons/launch-glyph.svg "External link icon")](cdn-example-code.md#example-code-of-listing-vendors)
* `verifyOrder` - Verifies whether the order can be placed.  [Example code ![External link icon](../../icons/launch-glyph.svg "External link icon")](cdn-example-code.md#example-code-to-verify-order)
* `placeOrder`  - Creates the CDN account with a given vendor.  [Example code ![External link icon](../../icons/launch-glyph.svg "External link icon")](cdn-example-code.md#example-code-to-place-order)
* `createDomainMapping` - Creates the CDN Mapping.  [Example code ![External link icon](../../icons/launch-glyph.svg "External link icon")](cdn-example-code.md#example-code-to-create-cdn-or-create-domain-mapping)
* `verifyDomainMapping` - Changes CDN status to _RUNNING_  [Example code ![External link icon](../../icons/launch-glyph.svg "External link icon")](cdn-example-code.md#example-code-of-verify-domain-mapping)

You can use the other APIs after you've followed the previous sequence.

[Example Code is available for each step in this call sequence ![External link icon](../../icons/launch-glyph.svg "External link icon").](./cdn-example-code.md)
