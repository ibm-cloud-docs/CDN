...
![cors-simple](/images/cors-simple.png){: caption="First request (resource access)" caption-side="bottom"}
...
![cors-preflight](/images/cors-preflight.png){: caption="First request (preflight)" caption-side="bottom"}

Second request (resource access):

![cors-after-preflight](/images/cors-after-preflight.png){: caption="Second request (resource access)" caption-side="bottom"}
...
![cors-through-cdn](/images/cors-through-cdn.png){: caption="CORS for CDN" caption-side="bottom"}
